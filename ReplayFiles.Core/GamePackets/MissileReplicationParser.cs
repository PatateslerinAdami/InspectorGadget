...
public class MissileReplicationData
{
...
public class MissileReplicationParser : GamePacketParser
{
    protected override object ReadBody(uint routingNetId, ref SpanReader reader)
    {
        var data = new MissileReplicationData { RoutingNetID = routingNetId };

        data.Position = new Vector3(reader.ReadSingleLittleEndian(), reader.ReadSingleLittleEndian(), reader.ReadSingleLittleEndian());
        data.CasterPosition = new Vector3(reader.ReadSingleLittleEndian(), reader.ReadSingleLittleEndian(), reader.ReadSingleLittleEndian());
        data.Direction = new Vector3(reader.ReadSingleLittleEndian(), reader.ReadSingleLittleEndian(), reader.ReadSingleLittleEndian());
        data.Velocity = new Vector3(reader.ReadSingleLittleEndian(), reader.ReadSingleLittleEndian(), reader.ReadSingleLittleEndian());
        data.StartPoint = new Vector3(reader.ReadSingleLittleEndian(), reader.ReadSingleLittleEndian(), reader.ReadSingleLittleEndian());
        data.EndPoint = new Vector3(reader.ReadSingleLittleEndian(), reader.ReadSingleLittleEndian(), reader.ReadSingleLittleEndian());
        data.UnitPosition = new Vector3(reader.ReadSingleLittleEndian(), reader.ReadSingleLittleEndian(), reader.ReadSingleLittleEndian());

        data.TimeFromCreation = reader.ReadSingleLittleEndian();
        data.Speed = reader.ReadSingleLittleEndian();
        data.LifePercentage = reader.ReadSingleLittleEndian();
        data.TimedSpeedDelta = reader.ReadSingleLittleEndian();
        data.TimedSpeedDeltaTime = reader.ReadSingleLittleEndian();

        byte bitfield1 = reader.ReadByte();
        data.Bounced = (bitfield1 & 1) != 0;
